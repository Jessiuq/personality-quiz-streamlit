    ...
    questions = [
        {
            ...
            "options": [
                ("Logical – I carefully consider each option, considering the facts, pros, and cons to make the most logical decision", [5, 6, 7], ["classic", "procrastinator"]),
                ("Emotional – I focus on how each option affects my emotions and aligns with my values to guide my decision", [2, 3, 4], ["parisian"]),
                ("Instinctual – I rely on my instincts or gut feelings to guide me toward the option that feels intuitively right", [8, 9, 1], ["messy", "intense"])
            ]
        },
        {
            "number": 2,
        ...
        },
        {
            ...
            "options": [
                ("I prefer to spend time alone to focus on managing my feelings and thoughts privately", [5], ["procrastinator", "classic"]),
        ...
        },
        {
            ...
            "options": [
                ("I take time to process it alone, reflecting on its impact and gathering more details", [5], ["procrastinator", "classic"]),
        ...
        },
        {
            ...
            "options": [
                ...
                ("I keep trying until I succeed, to demonstrate my capability and feel capable", [3], ["intense", "classic"]),
                ("I focus on my strengths and unique talents, to remind myself of my worth and potential", [4], ["messy", "procrastinator"])
            ]
        },
        {
            "number": 6,
            ...
            "options": [
                ...
                ("I highlight my skills or achievements by discussing areas where I feel confident and capable", [3], ["intense", "classic"]),
                ("I share something unique about myself, such as a personal talent or quality that I value", [4], ["messy", "procrastinator"])
            ]
        },
        {
            "number": 7,
            ...
            "options": [
                ("I let them know how I feel, openly expressing my anger or frustration", [8], ["intense", "messy"]),
                ("I minimize or ignore my anger to avoid conflict and keep the peace", [9], ["parisian", "procrastinator"]),
        ...
        },
        {
            ...
            "options": [
                ...
                ("I am concerned that I might make mistakes and how those could impact the success of the commitment", [1], ["procrastinator", "intense"]),
        ...
        },
        {
            ...
            "options": [
                ...
                ("I concentrate on my strengths and remind myself of past successes to approach the challenge with confidence", [3, 7, 8], ["messy", "intense"])
            ]
        },
        {
            "number": 10,
            ...
            "options": [
                ...
                ("I address the issue by analyzing it objectively and look for practical solutions", [3, 1, 5], ["classic", "procrastinator"]),
        ...
        },
        {
            ...
            "options": [
                ("I take time to process my feelings before deciding how best to proceed", [4, 6], ["procrastinator", "parisian"]),
                ("I quickly return to the project, using the criticism to guide my actions and improve", [3, 9], ["intense", "classic"])
            ]
        },
        {
            "number": 12,
            ...
            "options": [
                ...
                ("I reevaluate the goal and might try different approaches before deciding if I need to change or abandon it", [4, 7], ["messy", "procrastinator"])
            ]
        },
        {
            "number": 13,
            ...
            "options": [
                ...
                ("I would be cautious, preferring to keep my feelings private since I don’t know them well", [5, 6], ["procrastinator", "classic"])
            ]
        },
        {
            "number": 14,
            ...
            "options": [
                ("I’d feel proud of the role I played in their success, even if I didn’t get the raise", [2, 8], ["parisian", "messy"]),
                ("I’d feel disappointed that I missed out on the opportunity I wanted", [1, 3], ["intense"])
            ]
        },
        {
            "number": 15,
            ...
            "options": [
                ...
                ("I’d respect their space and focus on my own life, letting things develop naturally", [1, 5], ["classic", "procrastinator"])
            ]
        },
        {
            "number": 16,
            ...
            "options": [
                ("Take on a role that allows for creative control and shaping the project’s direction", [4, 7], ["intense", "messy"]),
                ("Contribute as a supportive team member, helping others and ensuring the project runs smoothly", [6, 9], ["parisian", "procrastinator"])
            ]
        },
        {
            "number": 17,
            ...
            "options": [
                ("I’d consider if the trip will advance my career and align with my personal goals", [3, 1], ["classic", "intense"]),
        ...
        },
        {
            ...
            "options": [
                ("I’d focus on the contributions I made to the company and the impact I had on my coworkers", [1, 8], ["parisian"]),
                ("I’d focus on the personal growth and valuable experiences I gained during my time there", [5, 9], ["messy"])
            ]
        },
        {
            "number": 19,
        ...
        },
        {
            ...
            "options": [
                ("I take responsibility and handle the task on my own, trusting in my abilities to manage it", [1], ["classic", "intense"]),
                ("I seek advice or assistance from others with more experience to ensure the task is completed effectively", [6], ["parisian", "procrastinator"])
            ]
        },
        {
            "number": 22,
            ...
            "options": [
                ("I’d propose an alternative restaurant that everyone can enjoy", [1], ["messy", "intense"]),
                ("I’d agree with their choice and go along with their decision, even if it’s not my favorite spot", [9], ["procrastinator", "parisian"])
            ]
        },
        {
            "number": 23,
            ...
            "options": [
                ...
                ("I prefer to make a detailed plan independently first, then seek feedback and make adjustments as needed", [5], ["classic", "procrastinator"])
            ]
        },
        {
            "number": 24,
            ...
            "options": [
                ("I’d agree to help with the move, even if it means altering my plans for personal enjoyment", [2], ["parisian", "messy"]),
                ("I’d politely decline, explaining that I need the day for myself to focus on self-care", [7], ["classic"])
            ]
        },
        {
            "number": 25,
            ...
            "options": [
                ("I’d assess and compare my progress with theirs to see where I stand", [3], ["intense", "procrastinator"]),
                ("I’d reach out to them and share ideas, even if it means they might reach the goal first", [2], ["parisian", "messy"])
            ]
        },
        {
            "number": 26,
            ...
            "options": [
                ...
                ("I often feel alone or disconnected, despite the company", [4], ["procrastinator", "classic"])
            ]
        },
        {
            "number": 27,
        ...
        },
        {
            ...
            "options": [
                ("I prefer to concentrate on one task at a time to manage everything smoothly", [9], ["classic", "procrastinator"]),
        ...
        },
        {
            ...
            "options": [
                ("They typically ask for my insight and knowledge on the matter", [5], ["classic", "procrastinator"]),
                ("They often rely on my decisiveness and ability to take charge in situations", [8], ["intense"])
            ]
        },
        {
            "number": 30,
            "question": "You come across potentially upsetting information, what are you more likely to do?",
            "options": [
                ("I would read it to stay informed, even if it might be distressing", [5], ["intense", "classic"]),
        ...
        },
        {
            ...
            "options": [
                ...
                ("I prefer to decide independently without seeking outside opinions", [8], ["classic", "intense"])
            ]
        },
        {
            "number": 33,
            ...
            "options": [
                ...
                ("I’d explore a different hobby that is more enjoyable and aligns better with my interests", [4], ["messy", "procrastinator"])
            ]
        },
        {
            "number": 34,
        ...
        },
        {
            ...
            "options": [
                ("I’d immediately shift my approach to align with the new requirements, adapting quickly in order to achieve the desired result", [3], ["messy", "intense"]),
